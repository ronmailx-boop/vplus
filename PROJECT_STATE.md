...
## Current Focus
**הבנייה המלאה + העיצוב מחדש (Nocturne) + וריאציית הכרטיסים + סרגל ניווט תחתון הושלמו ומוזגו ל-main.** האפליקציה כוללת: רשימות/פריטים מלאים, קטגוריות אוטומטיות, היסטוריה וסטטיסטיקה עם גרפים, Autocomplete/מחירון, ייבוא (טקסט/לוח/Excel/קול), גרירה-לסידור, נעילה, בחירה מרובה, הדפסה, PWA מלא, עיצוב Nocturne כהה עם כרטיסי פריטים מוגבהים וסרגל ניווט תחתון (FAB "+ פריט" ראשון מימין) — הכל ללא Firebase, ללא מודול פיננסי, ללא הגדרות/פוש/גוגל לוגין/סריקת קבלה, לפי ההחלטות שנקבעו.
