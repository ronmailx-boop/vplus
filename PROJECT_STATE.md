...
## Current Focus
**הבנייה המלאה + מחזור עיצובים (Nocturne → כרטיסים → סרגל תחתון → חזרה לעיצוב המקורי הצבעוני → מודלים מעוגנים למעלה → הסרת כפתור תקציב מהסרגל) הושלמו ומוזגו ל-main.** האפליקציה כוללת: רשימות/פריטים מלאים, קטגוריות אוטומטיות וצבועות, היסטוריה וסטטיסטיקה עם גרפים, Autocomplete/מחירון, ייבוא (טקסט/לוח/Excel/קול), גרירה-לסידור, נעילה, בחירה מרובה, הדפסה, PWA מלא, ועיצוב בהיר/צבעוני התואם למקור (סגול/ירוק, סרגל גרדיאנט תחתון, פילים צבעוניים) — הכל ללא Firebase, ללא מודול פיננסי, ללא הגדרות/פוש/גוגל לוגין/סריקת קבלה, לפי ההחלטות שנקבעו.
